...
# $4 - 配置名称 (模式为config时使用)
# $5 - 设备模式 (all/config)
# $6 - 设备配置名 (模式为config时使用)
# $7 - 调试模式设备名 (模式为debug时使用)
# $8 - 源码配置文件路径 (可选，默认为configs/sources.config)
# $9 - 设备配置文件路径 (可选，默认为configs/devices.config)
...
DEVICE_CONFIG="$6"
DEBUG_DEVICE="$7"
CONFIG_FILE="${8:-configs/sources.config}"
DEVICE_CONFIG_FILE="${9:-configs/devices.config}"
